...
<div class="main-content-card">
    <div class="content-header">
        <h2 class="content-title">Tambah Data Pelatihan</h2>
        <p style="color: #6b7280; margin: 0;">Tambahkan pelatihan baru ke sistem</p>
    </div>
    ...
    <form action="{{ route('trainings.store') }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror" 
                       value="{{ old('code') }}" placeholder="Contoh: K3-001" required>
                @error('code')
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" 
                       value="{{ old('name') }}" placeholder="Masukkan nama pelatihan" required>
                @error('name')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select id="level" name="level" class="form-select @error('level') is-invalid @enderror" required>
                    ...
                    <option value="0" {{ old('level') == '0' || old('level') == 'umum' ? 'selected' : '' }} data-level="0">Umum</option>
                    @for($i = 1; $i <= 7; $i++)
                        <option value="{{ $i }}" {{ old('level') == $i ? 'selected' : '' }} data-level="{{ $i }}">Level {{ $i }}</option>
                    @endfor
                </select>
                @error('level')
                    <div class="error-message">{{ $message }}</div>
            ...
            <div class="checkbox-group" id="jobPositionsGroup">
                <div class="checkbox-item">
                    <input type="checkbox" id="job_manajer" name="relevant_job_positions[]" 
                           value="Manajer" {{ in_array('Manajer', old('relevant_job_positions', [])) ? 'checked' : '' }}>
                    <label for="job_manajer">Manajer</label>
                </div>
                <div class="checkbox-item">
                    <input type="checkbox" id="job_supervisor" name="relevant_job_positions[]" 
                           value="Supervisor(Asmen)" {{ in_array('Supervisor(Asmen)', old('relevant_job_positions', [])) ? 'checked' : '' }}>
                    <label for="job_supervisor">Supervisor(Asmen)</label>
                </div>
                <div class="checkbox-item">
                    <input type="checkbox" id="job_staff" name="relevant_job_positions[]" 
                           value="Staff" {{ in_array('Staff', old('relevant_job_positions', [])) ? 'checked' : '' }}>
        ...
        <div class="form-row-3">
            ...
            <div class="form-group">
                ...
                <input type="number" id="duration_days" name="duration_days" class="form-control @error('duration_days') is-invalid @enderror" 
                       value="{{ old('duration_days') }}" placeholder="0" min="0">
                @error('duration_days')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="certificate_active_years" name="certificate_active_years" class="form-control @error('certificate_active_years') is-invalid @enderror" 
                       value="{{ old('certificate_active_years') }}" placeholder="Contoh: 3" min="0">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="institution" name="institution" class="form-control @error('institution') is-invalid @enderror" 
                       value="{{ old('institution') }}" placeholder="Nama lembaga penyelenggara">
                @error('institution')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="certification_code" name="certification_code" class="form-control @error('certification_code') is-invalid @enderror" 
                       value="{{ old('certification_code') }}" placeholder="Contoh: K3-CERT-004">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="institution_phone" name="institution_phone" class="form-control @error('institution_phone') is-invalid @enderror" 
                       value="{{ old('institution_phone') }}" placeholder="Contoh: 021-1234567">
            ...
            <div class="form-group">
                ...
                <input type="email" id="institution_email" name="institution_email" class="form-control @error('institution_email') is-invalid @enderror" 
                       value="{{ old('institution_email') }}" placeholder="email@lembaga.com">
        ...
        <div class="form-group">
            ...
            <input type="text" id="institution_address" name="institution_address" class="form-control @error('institution_address') is-invalid @enderror" 
                   value="{{ old('institution_address') }}" placeholder="Alamat lengkap lembaga">
        ...
        <div class="form-group">
            ...
            <textarea id="competencies_gained" name="competencies_gained" class="form-control @error('competencies_gained') is-invalid @enderror" 
                      rows="3" placeholder="Jelaskan kompetensi yang akan didapat dari pelatihan ini">{{ old('competencies_gained') }}</textarea>
        ...
        <div class="form-group">
            ...
            <textarea id="next_competencies" name="next_competencies" class="form-control @error('next_competencies') is-invalid @enderror" 
                      rows="3" placeholder="Jelaskan kompetensi lanjutan yang bisa diikuti setelah pelatihan ini">{{ old('next_competencies') }}</textarea>
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" 
                      rows="4" placeholder="Deskripsi lengkap tentang pelatihan">{{ old('description') }}</textarea>
            @error('description')
                <div class="error-message">{{ $message }}</div>
            @enderror
        </div>

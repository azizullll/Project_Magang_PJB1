...
<div class="main-content-card">
    <div class="content-header">
        ...
        <p style="color: #6b7280; margin: 0;">Tambahkan karyawan baru ke sistem</p>
    </div>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="nip" name="nip" class="form-control @error('nip') is-invalid @enderror" 
                       value="{{ old('nip') }}" placeholder="Masukkan NIP karyawan" required>
                @error('nip')
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                       value="{{ old('email') }}" placeholder="Masukkan email karyawan">
                @error('email')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="number" id="masa_kerja_tahun" name="masa_kerja_tahun" class="form-control @error('masa_kerja_tahun') is-invalid @enderror" 
                       value="{{ old('masa_kerja_tahun', 0) }}" placeholder="0" min="0" required>

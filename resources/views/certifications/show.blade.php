            ...
            <div class="row">
                <div class="col-md-2">
                    @if($employee->foto_path)
                        <img src="{{ asset('storage/' . $employee->foto_path) }}" 
                                ...
                                <td>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted d-block">
                                            ...
                                            @else
                                                {{ abs($daysUntilExpiration) }} hari lalu
                                            @endif
                                        </small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <form action="{{ route('certifications.destroy', [$employee->id, $training->id]) }}" 
                                              method="POST" 
                                              onsubmit="return confirm('Apakah Anda yakin ingin menghapus sertifikasi ini?')"
                                              class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-danger" title="Hapus Sertifikasi">
